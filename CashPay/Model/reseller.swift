...
class ResellerData: Object , Mappable {
    
    @objc dynamic var id: String = "0"
    @objc dynamic var status: String = ""
    @objc dynamic var message: Reseller?
...
class Reseller: Object , Mappable{
...
class ResellerModel {
    ...
    static var shared = ResellerModel()
