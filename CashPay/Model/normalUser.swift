...
class NormalUserData: Object , Mappable {
    
    @objc dynamic var id: String = "0"
    @objc dynamic var status: String = ""
    @objc dynamic var message: NormalUser?
...
class NormalUser: Object , Mappable{
...
class NormalUserModel {
    ...
    static var shared = NormalUserModel()
